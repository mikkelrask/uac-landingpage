...
If you have **Registry Lookups** enabled in **Settings** → **General**, the system will attempt to match your mod file against the online **UAC Registry** when adding it to the catalog. Matched files will auto-populate metadata like name and version. Registry lookups require an active connection to the UAC data centers.
